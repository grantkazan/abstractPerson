...
//		people.add(new PetOwner("Frazier", "Psychiatrist", "dog", "Eddie"));
		...
		people.add(new BengalsFan("Grant", "Student", "Cheese Coney"));
		people.add(new BengalsFan("George Clooney", "Actor", "3 way"));

		// steelers fan answers from a list
		people.add(new SteelersFan("Snoop Dogg", "Rapper"));
		people.add(new SteelersFan("Brett Michaels", "Rocker"));
		people.add(new SteelersFan("Russell Wilson", "Player"));
